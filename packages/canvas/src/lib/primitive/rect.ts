...
export function rect({ctx, x, y, width, height, colors, strokeWidth, radius}: RectArgs) {
    ctx.save();
...
export function strokeRect({ctx, x, y, width, height, color, strokeWidth}: StrokeRectArgs) {
    ctx.save();
